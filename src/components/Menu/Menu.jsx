...
const Menu = () => {
  ...
  return (
    <div className="flex justify-between items-center px-5 relative bg-gradient-to-b from-gray-900 to-transparent">
        ...
        <nav className={`${isOpen ? "flex fixed" : "hidden"} pb-8 bg-neutral-900 absolute top-full left-0 flex-col w-full items-center sm:flex sm:gap-3 sm:flex-row sm:relative sm:w-max sm:left-0`}>
