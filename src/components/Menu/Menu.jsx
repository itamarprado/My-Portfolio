  ...
  return (
    <div className="flex justify-center items-center px-5 fixed z-50 bg-gradient-to-b from-neutral-900 to-midnight w-full">
      <div className="flex justify-between w-full items-center max-w-6xl">
        ...
        <nav className={`${windowSize[0]<640 ? (isOpen ? "flex" : "hidden") : "flex"} z-50 pb-8 bg-midnight absolute top-full left-0 flex-col w-full items-center sm:flex sm:gap-3 sm:flex-row sm:relative sm:w-max sm:left-0 sm:pb-0 sm:bg-transparent`}>
