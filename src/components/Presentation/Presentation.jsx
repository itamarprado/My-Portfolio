            ...
            <div className="flex flex-col max-w-[1200px] md:flex-row items-center">
                ...
                <div className="md:flex-start md:max-w-[50%]">
                    <div className="flex gap-5 items-start w-full pb-2">
                            <FaGithub size={25} className="cursor-pointer hover:text-sky-500"/>
                            <FaTelegram size={25} className="cursor-pointer hover:text-sky-500"/>
                            <FaDiscord size={25} className="cursor-pointer hover:text-sky-500"/>
                            <FaLinkedin size={25} className="cursor-pointer hover:text-sky-500"/>
                    </div>
                    <div className="flex flex-col w-full self-start pb-5 max-w-[360px]">
                        ...
                        <h1 className="text-5xl font-bold bg-gradient-to-r from-sky-600 to-sky-200 bg-clip-text text-transparent">Developer</h1>
                    </div>
                    {/* Resume */}
                    <div className="font-light self-start">
                        ...
                        I&apos;m Itamar, a front-end developer with focus on Web Development. I&apos;m building my career path by learning new technologies and building solo projects to showcase my skills.
                    </div>

                    <div className="flex gap-5 pt-5">
                        <div className="flex items-center justify-center bg-gradient-to-br from-blue-700 to-sky-400 w-max rounded-lg p-[1px] hover:shadow-blue-700 hover:shadow-[0px_0px_25px_3px] duration-300">
                            <button className="px-5 py-2 bg-neutral-800 w-[calc(100% - 1px)] h-[calc(100%-1px)] rounded-lg">
                                Contact
                            </button>
                        </div>
                        <button className="flex px-5 py-2 items-center justify-center bg-gradient-to-r from-blue-700 to-sky-400 rounded-lg hover:shadow-blue-700 hover:shadow-[0px_0px_15px_3px] hover:scale-110 duration-150">
                            See projects
